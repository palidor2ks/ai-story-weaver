...
import {
  useTopSpenders,
  useIECycles,
  useTopSpendersRaised,
  useTopSpendersCauses,
  type SpenderRow,
  type Stance,
} from '@/hooks/useTopSpenders';
...
export default function TopSpenders() {
  ...
  const { data: raisedMap } = useTopSpendersRaised(visibleIds);
  const { data: causeMap } = useTopSpendersCauses(visibleIds);
