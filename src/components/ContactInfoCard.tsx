...
export function ContactInfoCard({ representative }: ContactInfoCardProps) {
  ...
  if (website_url) summaryParts.push('Website');
  if (hasSocialMedia) summaryParts.push('Social');
  if (hasDistrictOffices) summaryParts.push(`${district_offices!.length} offices`);
          ...
          <CollapsibleTrigger asChild>
            <button className="w-full flex items-center justify-between text-left hover:bg-secondary/30 -mx-2 px-2 py-1 rounded-lg transition-colors">
              <div className="flex items-center gap-2">
                ...
                <span className="font-display font-semibold">Contact Information</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-xs text-muted-foreground hidden sm:inline">{summaryText}</span>
