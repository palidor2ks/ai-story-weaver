...
// The candidate-name formatter lives in its own dependency-free module so the
// CDN-baking script and edge functions can share the logic. Re-exported here for
// the many existing `import { formatCandidateName } from '@/lib/utils'` sites.
export { formatCandidateName } from './candidateName';
