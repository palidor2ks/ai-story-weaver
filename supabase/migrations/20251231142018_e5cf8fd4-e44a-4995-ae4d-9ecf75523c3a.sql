...
-- Recreate get_contribution_totals with organization_total and fixed individual filter
CREATE OR REPLACE FUNCTION public.get_contribution_totals(p_candidate_id text, p_cycle text)
 RETURNS TABLE(individual_total bigint, pac_total bigint, party_total bigint, itemized_total bigint, transfers_total bigint, earmarked_total bigint, passthrough_total bigint, other_total bigint, loans_total bigint, organization_total bigint, contribution_count bigint)
 LANGUAGE sql
...
-- Recreate get_contribution_totals_by_committee with same fix
CREATE OR REPLACE FUNCTION public.get_contribution_totals_by_committee(p_candidate_id text, p_cycle text)
 RETURNS TABLE(committee_id text, individual_total bigint, pac_total bigint, party_total bigint, itemized_total bigint, transfers_total bigint, earmarked_total bigint, other_total bigint, loans_total bigint, organization_total bigint, contribution_count bigint)
 LANGUAGE sql
 STABLE SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
