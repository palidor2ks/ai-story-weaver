-- Update get_contribution_totals to exclude Line 12 (transfers) from itemized_total
...
AS $function$
  SELECT
    ...
    -- FIXED: Exclude Line 12 (transfers) from itemized_total
    -- Also exclude Line 15 (other receipts), Line 13A (candidate loans), Line 11D (candidate contributions)
    -- and memo_code='X' duplicates
    COALESCE(SUM(CASE 
    ...
    -- Transfers tracked separately (Line 12)
    COALESCE(SUM(CASE 
