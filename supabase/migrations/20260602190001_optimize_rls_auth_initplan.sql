...
--
-- Wrapping auth.uid()/auth.role() in a scalar subquery, e.g. (select auth.uid()),
-- lets Postgres evaluate the auth function once per statement (InitPlan) instead of
-- once per row. This is semantically identical to the original policies: roles,
-- command, USING and WITH CHECK logic are unchanged -- only the function call is
-- wrapped. Biggest win on large tables such as contributions and donors.
--
-- 163 policies across 77 tables are recreated below. Statements were generated from
-- pg_policies (so each expression matches the live definition); only auth.uid() and
-- auth.role() were rewritten via regexp.
--
-- Each table's policies are wrapped in a guarded DO block. If the table is absent the
-- block returns early instead of failing. This matters because a few tables exist only
-- on the live project and are not created by any committed migration file
-- (donor_sync_runs, job_queue, job_runs, job_dead_letters), so a database built purely
-- from these migration files -- e.g. a Supabase preview branch -- would otherwise error
-- on DROP POLICY ... ON <missing table>. On the live database every table is present, so
-- all 163 policies are optimized. Each DO block runs atomically, so RLS is never
-- disabled mid-flight.

DO $mig$
BEGIN
  IF to_regclass('public.admin_stats_cache') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.ai_analysis_cache') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.badge_definitions') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.bill_ingestion_status') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.bill_sponsors') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.bill_sync_status') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.bills') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.candidate_answers') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.candidate_committees') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.candidate_fec_ids') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.candidate_overrides') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.candidate_votes') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.civic_lookup_cache') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.committee_aliases') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.committee_causes') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.committee_finance_rollups') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.committee_topics') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.contributions') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.donor_alias_members') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.donor_aliases') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.donor_cause_overrides') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.donor_import_sessions') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.donor_sync_runs') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.donors') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.election_candidates') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.elections') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.external_committee_finance') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.external_pacs') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.fec_committee_sync_status') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.finance_reconciliation') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.hidden_states') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.ie_excluded_committees') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.ie_import_sessions') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.independent_expenditures') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.job_dead_letters') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.job_queue') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.job_runs') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.mayor_fetch_queue') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.news_article_questions') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.official_transitions') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.pac_candidate_totals') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.pac_expenditures') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.party_answers') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.party_platforms') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.pending_badge_notifications') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.poll_response_answers') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.poll_responses') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.poll_social_posts') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.profile_access_log') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.profile_claims') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.question_news_feed_cache') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.question_options') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.question_update_notifications') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.quiz_answers') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.representative_social_posts') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.share_cards') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.social_post_platforms') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.social_post_settings') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.social_posts') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.static_officials') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.user_activity_events') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.user_badges') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.user_party_comparisons') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.user_rep_comparisons') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.user_topic_scores') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.user_topics') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.vendor_refund_organizations') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.vote_sync_status') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.x_account_tokens') IS NULL THEN RETURN; END IF;
...
DO $mig$
BEGIN
  IF to_regclass('public.x_oauth_pending') IS NULL THEN RETURN; END IF;
