...
revoke all on function public.get_committee_cycles() from public, anon;
grant execute on function public.get_committee_cycles() to authenticated, service_role;
